...
object LTag {
  ...
  // FIXME: strengthen
  transparent inline implicit def materialize[T <: AnyKind]: LTag[T] = LTag(izumi.reflect.dottyreflection.Inspect.inspect[T])
  ...
  object Weak {
    ...
    // FIXME: weaken
    transparent inline implicit def materialize[T <: AnyKind]: LTag.Weak[T] = LTag.Weak(izumi.reflect.dottyreflection.Inspect.inspect[T])
  }
